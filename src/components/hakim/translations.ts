export const translations = {
    en: {
      ...
      heroDesc: 'Hakim transforms Ethiopian hospital queues with digital token booking, real-time updates, SMS notifications, and AI-assisted support for patients.',
      ...
      aiDoctorTitle: 'Smart AI Doctor',
      aiDoctorSubtitle: 'Ask health questions and get safe, concise guidance.',
      aiDoctorDisclaimer: 'This assistant does not provide a diagnosis or treatment plan. If this is an emergency, call 911 immediately.',
      aiDoctorPlaceholder: 'Describe how you feel or ask a health question...',
      aiDoctorEmpty: 'Start a conversation with the AI doctor.',
      aiDoctorName: 'AI Doctor',
      youLabel: 'You',
      sendLabel: 'Send',
    ...
    am: {
      ...
      notificationHistoryDesc: 'የቅርብ ጊዜ የSMS እና የስርዓት ማሳወቂያዎችዎ።',
      ...
      heroDesc: 'ሃኪም የኢትዮጵያን ሆስፒታል የመጠባበቂያ ሰርጸት በዲጂታል ቦታ ማስያ፣ የእውነታ ጊዜ አዘምን፣ የኤስኤምኤስ ማሳወቂያ እና በAI የተጠጋገረ ድጋፍ በመጠቀም ይቀይራል።',
      ...
      smsNotificationsActive: 'የSMS ማሳወቂያ ንቁ',
      smsDesc: 'ቀጣይ በመስመር ላይ ሲሆኑ እና ጊዜዎ ሲደርስ SMS ያገኛሉ።',
      // Hero Section Demo Card
      hospitalLabel: 'ሆስፒታል',
      departmentLabel: 'ክፍል',
      ...
      faqA2: 'አይ! መተግበሪያችን በስማርት ስልኮች ላይ በደንብ ቢሰራም፣ በማንኛውም መሰረታዊ ባህሪ ስልክ ላይ የSMS ማሳወቂያዎችን መቀበል ይችላሉ። ከግባት በኋላ ቦታ ማስያ በኢንተርኔት መድረሻ ያለው ማንኛውም መሣሪያ ላይ ይሰራል።',
      faqQ3: 'የእኔ ጊዜ መቼ እንደሆነ እንዴት አውቃለሁ?',
      faqA3: 'ከ10 ታካሚዎች ርቀት ላይ ሲሆኑ፣ ከ5 ታካሚዎች ርቀት ላይ ሲሆኑ፣ እና ጊዜዎ ሲደርስ የSMS ማሳወቂያዎችን ያገኛሉ። በመተግበሪያው ውስጥ ቦታዎን በእውነታ ጊዜ ማረጋገጥም ይችላሉ።',
      ...
      faqA6: 'አዎ! ለቤተሰብ አባላት ወይም ጓደኞች ቦታ ማስያ ይችላሉ። የSMS ማሳወቂያዎችን ለማግኘት በቦታ ማስያ ጊዜ የእነሱን ስልክ ቁጥር ያስገቡ።',
      ...
      privacyUse2: 'የመስመር ሁኔታዎን ለማሳወቅ የSMS ማሳወቂያዎችን ለመላክ',
      ...
      hipaaCompliant: 'HIPAA ተኮር እና የውሂብ ደህንነት',
      madeWith: 'የተሰራ',
      forEthiopia: 'ለኢትዮጵያ',
      // Regional Ambulance
      ...
      aiDoctorTitle: 'Smart AI Doctor',
      aiDoctorSubtitle: 'ጤና ጥያቄዎችን ይጠይቁ እና አጭር መመሪያ ያግኙ።',
      aiDoctorDisclaimer: 'ይህ አገልጋይ የህክምና ምርመራ ወይም ህክምና አይሰጥም። አደጋ ጊዜ ከሆነ 911 ይደውሉ።',
      aiDoctorPlaceholder: 'ምልክቶችዎን ግለጹ ወይም ጤና ጥያቄ ይጠይቁ...',
      aiDoctorEmpty: 'ከAI ዶክተር ጋር ውይይት ጀምሩ።',
      aiDoctorName: 'AI Doctor',
      youLabel: 'እርስዎ',
      sendLabel: 'ላክ',
      ...
      smsNotifications: 'የSMS ማሳወቂያ',
      smsNotificationsDesc: 'ቀጣይ በመስመር ላይ ሲሆኑ የSMS ማሳወቂያ ያግኙ። በማንኛውም ስልክ ይሰራል።',
      ...
      smsSystem: 'የSMS ስርዓት',
      smsNotificationsTitle: 'የSMS ማሳወቂያዎች',
      smsNotificationsPageDesc: 'በማንኛውም ሞባይል ስልክ ላይ ይሰራል - ስማርት ስልክ አያስፈልግም። ታካሚዎች በቁልፍ ጊዜያት ራስ-ሰር የSMS ማሳወቂያዎችን ያገኛሉ፡ ሲያስይዙ፣ ከ10 ታካሚዎች ርቀት ላይ ሲሆኑ፣ ከ5 ታካሚዎች ርቀት ላይ ሲሆኑ፣ እና ጊዜያቸው ሲደርስ።',
      ...
      smsFirstDesign: 'የSMS-የመጀመሪያ ዲዛይን',
      ...
      agreeToPrivacy: 'የግላዊነት ፖሊሲን ተቀብያለሁ',
